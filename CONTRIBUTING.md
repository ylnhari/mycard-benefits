...
Contributions are welcome after the foundation milestone. Read `AGENTS.md` and
`docs/SOURCE-POLICY.md` first.

- Use synthetic, non-personal fixtures.
- Submit atomic catalog assertions with primary-source URLs, effective dates,
  retrieval date, content hash, and neutral wording.
- Aggregators and community reports are discovery leads, not verification.
