...
OFFERINGS = (
    ...
    ("dbs-emt-visa-signature-debit", "DBS EMT Visa Signature Debit Card", "dbs-bank", "emt-visa-signature-debit", "visa-signature", None),
    ("dbs-treasures-visa-infinite-debit", "DBS Treasures Visa Infinite Debit Card", "dbs-bank", "treasures-visa-infinite-debit", "visa-infinite", None),
    ("dbs-visa-platinum-debit-growth-max", "DBS Visa Platinum Debit Card (Growth Max)", "dbs-bank", "visa-platinum-debit", "visa-platinum", None),
    ("dbs-visa-signature-debit-aspire", "DBS Visa Signature Debit Card (Aspire)", "dbs-bank", "visa-signature-debit", "visa-signature", None),
